...
(function () {
  var AR = {
    ...
    'Why ProBase Global': 'لماذا بروبيس جلوبال',
    'Built to remove the friction that stalls complex programmes.': 'مبنية لإزالة الاحتكاك الذي يُعطّل البرامج المعقّدة.',
    'One accountable partner': 'شريك واحد مسؤول',
    'Single ownership across technology, engineering, infrastructure and operations, so the interfaces do not fall between separate vendors.': 'ملكية واحدة عبر التقنية والهندسة والبنية التحتية والتشغيل، فلا تقع التداخلات بين موردين منفصلين.',
    'Structured delivery': 'تسليم منظّم',
    'Clear scope, readiness gates and visible handovers keep the line from strategy to operations under control.': 'نطاق واضح وبوابات جاهزية وتسليمات ظاهرة تُبقي الخط من الاستراتيجية إلى التشغيل تحت السيطرة.',
    'Sector-aware': 'وعي بالقطاع',
    'A consistent capability model, shaped to the assets, governance, continuity and users of each sector.': 'نموذج قدرات ثابت، يُشكَّل وفق أصول القطاع وحوكمته واستمراريته ومستخدميه.',
    'Evidence-led': 'قائم على الأدلة',
    'Decisions stay traceable to programme outcomes, and claims are published only once verified.': 'تبقى القرارات قابلة للتتبّع إلى مخرجات البرنامج، ولا تُنشر الادعاءات إلا بعد التحقق.',
    ...
    'Goals, constraints and priorities': 'الأهداف والقيود والأولويات',
    'Systems, standards and interfaces': 'الأنظمة والمعايير والواجهات',
    'Build, install and commission': 'البناء والتركيب والتشغيل',
    'Handover, maintenance and support': 'التسليم والصيانة والدعم',
    ...
    'PBG / DELIVERY TIMELINE': 'PBG / الخط الزمني للتسليم',
    'A clear line from first conversation to steady operations.': 'خط واضح من أول محادثة إلى تشغيل مستقر.',
    'Clarify the need, scope boundaries, stakeholders and dependencies.': 'توضيح الحاجة وحدود النطاق وأصحاب المصلحة والتبعيات.',
    'Set the technical architecture and coordinate the workstreams.': 'تحديد البنية التقنية وتنسيق مسارات العمل.',
    'Build, install and commission under clear, visible controls.': 'البناء والتركيب والتشغيل تحت ضوابط واضحة وظاهرة.',
    'Hand over, then support operations and continuity.': 'التسليم، ثم دعم التشغيل والاستمرارية.',
    'What partners say': 'ماذا يقول شركاؤنا',
    'Trusted on complex, multi discipline programmes.': 'موثوقون في البرامج المعقّدة متعددة التخصصات.',
    'Sample placeholders: replace with real, approved client quotes.': 'عناصر تجريبية: استبدلها باقتباسات عملاء حقيقية ومعتمدة.',
    'One accountable team across every discipline removed the gaps we used to manage between separate vendors.': 'فريق واحد مسؤول عبر كل التخصصات أزال الفجوات التي كنا ندير بين موردين منفصلين.',
    'Programme Director, Government entity': 'مدير برنامج، جهة حكومية',
    'Delivery stayed visible from strategy to operations, with clear handovers at every stage.': 'بقي التسليم واضحاً من الاستراتيجية إلى التشغيل، مع تسليمات واضحة في كل مرحلة.',
    'Head of Technology, Enterprise': 'رئيس التقنية، مؤسسة',
    'A consistent model that adapted to our sector without losing momentum.': 'نموذج ثابت تكيّف مع قطاعنا دون فقدان الزخم.',
    'Operations Lead, Healthcare': 'قائد التشغيل، رعاية صحية',
