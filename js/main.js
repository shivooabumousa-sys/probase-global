document.addEventListener('DOMContentLoaded', function () {
  ...
  if (!(window.matchMedia && window.matchMedia('(prefers-reduced-motion: reduce)').matches)) {
    var revealSel = '.overview-copy h2, .layers h2, .layer-card, .capmap-grid article, .dir-item, .scenario-item, .case-item, .cases h2, .outcomes-list li, .faq-item, .stats-band li, .partner-slot, .team-member, .routing-grid > div, .approach h2, .approach p';
    var pending = [];
